...
import 'package:moment/models/model.dart';
...
class _EditState extends State<Edit> {
  ...
  void fetchMoment() async {
    final m = await Model.loadMomentById(widget.id);
    if (m.length == 1) {
      final res = m[0];
              ...
              child: Column(
                children: <Widget>[
                  new TextFormField(
                    ...
                    validator: (val) {
                      print(val);
                      return val.trim().length <= 0 ? "好像什么都没写呢 ,,ԾㅂԾ,," : null;
                    },
                  ),
                  GestureDetector(
                    child: Container(
                      child: new TextFormField(
                        ...
                        validator: (val) {
                          return val.length <= 0 ? "好像什么都没写呢 ,,ԾㅂԾ,," : null;
                        },
                      ),
                    ),
                  ),
